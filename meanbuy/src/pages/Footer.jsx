...
import {VStack,Box,Text,Image,Heading,Link,Flex,Grid,Button,InputGroup,Input,InputRightElement,Divider,Spacer,HStack} from "@chakra-ui/react"
import { FaYoutube,FaInstagramSquare,FaLinkedin,FaCcVisa,FaAmazonPay,FaCcMastercard,FaTwitter } from "react-icons/fa";
const Footer = () => {

    return(
        <Box pt='15px' bg='#e9e9e9'>
            <Grid templateColumns='repeat(5, 1fr)' gap={6} p='10px'>
              ...
              <HStack spacing='24px'><FaYoutube color="red" size='30px' /><FaInstagramSquare color="#8a3ab9" size='30px' />
              <FaLinkedin color="#0A66C2" size='30px' /><FaTwitter color='#1c9cea' size='30px'/></HStack>
              <HStack spacing='24px'><FaCcVisa color="	#1A1F71" size='30px'/> <FaAmazonPay color="#f79c34" size='30px'/> <FaCcMastercard size='30px' color="#EB001B"/></HStack>
              </VStack>
           ...
           <Text fontSize='lg' mt='10px' color='orange.500' fw='bold' fontWeight='bold'> In love with React & Next</Text>
            <Text fontSize='sm'>Meanbuy is a comprehensive platform for you to choose how you shop, whether it is buying 
            instantly,
             waiting to save or to pick up your order from the store after freezing it.</Text>
             <Spacer />
            <Text fontSize='sm'>Everyone will agree that it is not easy to go down to the market in massive traffic, driving
             ...
             <Text fontSize='lg'  mt='10px' color='orange.500' fontWeight='bold'> Get The Best Of Your Online Shopping Experience</Text>
             <Text fontSize='sm'>Keeping mind the fact that everything is just a tap away in today's world, fashion and clothing have no 
                ...
                <Spacer/>
                <Text fontSize='lg'  mt='10px' color='orange.500' fontWeight='bold'> Meanbuy Let You choose At Your Convenience</Text>
                <Text fontSize='sm'>What if you belong to the former kind, where you like to buy the product from the shop after analyzing it 
